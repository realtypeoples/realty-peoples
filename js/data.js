...
const RESIDENTIAL_LISTINGS = [
  {city:"Gardena, CA", desc:"2 bed · 2.5 bath · 1,281 sqft — Listed at $752K, offering modern living in a prime location. Conveniently close to schools, shopping, dining, and everyday amenities.", tag:"For Sale", img:"gardena.png", detail:"Sold in 2024. A sun-filled Spanish revival with a private courtyard, chef's kitchen, and detached casita. Add full property details here."},
  {city:"Chino, CA", desc:"4 bed · 3.5 bath · 1,930 sqft — Newly built home, a cozy modern estate near top-rated schools and great social hubs.", tag:"IN ESCROW", img:"nesta.png", detail:"Highlights of the must-see Nesta plan include a spacious great room, a convenient powder room, and a thoughtfully designed kitchen boasting a center island and an adjacent dining area. You’ll also appreciate a main-floor bedroom and bathroom. An airy loft can be found upstairs, as can a laundry, two secondary bedrooms with a shared bath, and a beautiful primary suite offering a private bath with double sinks and an immense walk-in closet.
"},
  {city:"Fontana, CA", desc:"3 bed · 3 bath · 1,677 sqft — Great recently built townhouse in a crisp, newly developed location, providing great views of California and the San Bernadino Valley.", tag:"Sold", img:"Highlights of the must-see Nesta plan include a spacious great room, a convenient powder room, and a thoughtfully designed kitchen boasting a center island and an adjacent dining area. You’ll also appreciate a main-floor bedroom and bathroom. ", detail:"A charming hillside home with sweeping city views and updated interiors. Add full property details here."},
